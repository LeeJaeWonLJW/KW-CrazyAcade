...
void * action_handle(void *arg);
void user_action(char *msg, int len);
...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        pthread_create(&t_id, NULL, action_handle, (void*)&clnt_sock);
        pthread_detach(t_id);
        printf(" Player IP : %s ", inet_ntoa(clnt_adr.sin_addr));
